...
public class Tela002 extends AppCompatActivity implements ProdutoAdapter.OnClickProdutoListener {
    ...
    public void onClick_ib_home(View v) {
        Intent it_trocaTela = new Intent(Tela002.this, Principal.class);
    ...
    public void onClick_ib_pesquisa(View v) {
        Intent it_trocaTela = new Intent(Tela002.this, Tela004.class);
        startActivity(it_trocaTela);
    }
    ...
    public void onClick_ib_carrinho(View v) {
        Intent it_trocaTela = new Intent(Tela002.this, Tela005.class);
        startActivity(it_trocaTela);
    }
    ...
    public void onClick_ib_search(View v) {
        ...
        if (!busca.isEmpty()) {
            try {
                ResultSet resultSet = banco.select("SELECT produto.cod_produto, produto.marca ,produto.tipo ,produto.peso ,produto.caracteristicas ,produto.preco ,produto.qtd_estoque ,mercado.cod_mercado, mercado.nome_mercado  FROM produto natural join mercado where produto.tipo='" + busca+"';");
                if (resultSet != null) {
                    while (resultSet.next()) {
                        Produto obj = new Produto();
                        obj.setPrice(resultSet.getFloat("preco"));
